...
// It uses a single-page app (SPA) approach, where navigation is handled by showing and hiding sections.
    ...
    if (serviceCards.length > 0) {
        serviceCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                // Display a professional, non-disruptive message box instead of an 'alert'.
